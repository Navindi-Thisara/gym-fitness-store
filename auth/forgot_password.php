...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email)){
        ...
        $result = $conn->query("SELECT * FROM users WHERE email='$ce'");
        if($result->num_rows === 0){
            ...
            try {
                ...
                $mail->SMTPAuth   = true;
                $mail->Username   = 'navindithisara214@gmail.com'; // your Gmail
                $mail->Password   = 'ppte vriw sufk dmqs';         // your App Password
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
                $mail->Port       = 465;

                // Recipients
                $mail->setFrom('navindithisara214@gmail.com', 'Gym & Fitness Store');
                $mail->addAddress($user['email'], $user['name']);

                // Content
                $mail->isHTML(true);
                $mail->Subject = 'Password Reset - Gym & Fitness Store';
                $mail->Body    = "Hi ".$user['name'].",<br><br>"
                               . "Click the link below to reset your password (valid for 1 hour):<br>"
                               . "<a href='$resetLink'>$resetLink</a><br><br>"
                               . "If you did not request this, ignore this email.<br><br>"
                               . "Gym & Fitness Store Team";
...
<title>Forgot Password | Gym Store</title>
...
.btn-register{
    ...
    box-shadow:0 4px 14px rgba(40,167,69,0.35);margin-top:6px;letter-spacing:0.4px;
}
...
<div class="page-body">
    <div class="register-card">
        ...
        <div class="login-link">
            <a href="login.php"><i class="fa-solid fa-arrow-left" style="font-size:0.8rem;"></i> Back to Login</a>
        </div>
    </div>
